...
func GetrandomrecipesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/recipes/random%s", cfg.BaseURL, queryString)
...
func CreateGetrandomrecipesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_recipes_random",
		mcp.WithDescription("Get Random Recipes"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetrandomrecipesHandler(cfg),
	}
}
