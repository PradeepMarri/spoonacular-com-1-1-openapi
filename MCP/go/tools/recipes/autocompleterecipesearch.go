...
func AutocompleterecipesearchHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/recipes/autocomplete%s", cfg.BaseURL, queryString)
...
func CreateAutocompleterecipesearchTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_recipes_autocomplete",
		mcp.WithDescription("Autocomplete Recipe Search"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    AutocompleterecipesearchHandler(cfg),
	}
}
