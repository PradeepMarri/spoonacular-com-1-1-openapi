...
func GetmealplantemplatesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/mealplanner/%s/templates%s", cfg.BaseURL, username, queryString)
...
func CreateGetmealplantemplatesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_mealplanner_username_templates",
		mcp.WithDescription("Get Meal Plan Templates"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetmealplantemplatesHandler(cfg),
	}
}
