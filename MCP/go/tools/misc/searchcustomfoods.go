...
func SearchcustomfoodsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/food/customFoods/search%s", cfg.BaseURL, queryString)
...
func CreateSearchcustomfoodsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_food_customFoods_search",
		mcp.WithDescription("Search Custom Foods"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    SearchcustomfoodsHandler(cfg),
	}
}
