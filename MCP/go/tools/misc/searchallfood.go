...
func SearchallfoodHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/food/search%s", cfg.BaseURL, queryString)
...
func CreateSearchallfoodTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_food_search",
		mcp.WithDescription("Search All Food"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    SearchallfoodHandler(cfg),
	}
}
