...
func AutocompleteingredientsearchHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/food/ingredients/autocomplete%s", cfg.BaseURL, queryString)
...
func CreateAutocompleteingredientsearchTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_food_ingredients_autocomplete",
		mcp.WithDescription("Autocomplete Ingredient Search"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    AutocompleteingredientsearchHandler(cfg),
	}
}
