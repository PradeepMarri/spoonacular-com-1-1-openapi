# spoonacular API MCP Server

This MCP (Model Content Protocol) server provides access to spoonacular API API functionality through HTTP, HTTPS, and STDIO transport modes.
